...
export const getEffectiveModelsForTier = (
    ...
    if (tier === 'normal') {
        if (taskType === 'translate') {
            return getFallback(['gemini-3.1-pro-preview', 'gemini-3.7-flash', 'gemini-3.6-flash']);
        } else {
    ...
    if (tier === 'full') {
        if (taskType === 'translate') {
            return getFallback(['gemini-3.1-pro-preview', 'gemini-3.7-flash', 'gemini-3.6-flash', 'gemini-3-flash-preview']);
        } else {
