...
export const MainUI: React.FC<MainUIProps> = (props) => {
    ...
    // Dùng chung cho cả nút "Lưu Key" của khối OpenRouter lẫn khối DeepSeek trong popup
    // "Chưa cấu hình API Cứu Hộ": sau khi lưu 1 trong 2 key, tự động tiếp tục vào Automation
    // giống hệt luồng cũ (trước đây đoạn này bị lặp lại y hệt trong từng nút bấm).
                        ...
                        <div className="p-6 overflow-y-auto flex-1 overscroll-contain">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400">Smart Safety Filter cần OpenRouter hoặc DeepSeek để rà soát tệp vi phạm</p>
                                </div>
                            </div>
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-300 mb-6 bg-slate-50 dark:bg-slate-800/50 p-3 rounded-xl border border-slate-100 dark:border-slate-800">
                                Để hệ thống tự động xử lý và vượt qua rào cản kiểm duyệt khi dịch hàng loạt (Batch Auto-fix), bạn nên thêm API Key OpenRouter và/hoặc DeepSeek (OpenRouter sẽ được ưu tiên thử trước, DeepSeek dự phòng khi OpenRouter thất bại).
                            </p>
